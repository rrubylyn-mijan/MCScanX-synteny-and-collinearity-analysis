...
awk 'NR==FNR{bad[$1]; next} !($1 in bad)' bad-names-query.txt wheat-query.blast |
awk 'NR==FNR{bad[$1]; next} !($2 in bad)' bad-names-subject.txt wheat-subject.blast > wheat-subject-query.cleaned.blast
